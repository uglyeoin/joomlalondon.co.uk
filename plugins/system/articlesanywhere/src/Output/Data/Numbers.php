...
class Numbers
{
	...
	public function __construct($total_no_limit, $total_no_pagination, $total, Pagination $pagination)
	{
		...
		if ($this->pagination->params->limit)
		{
			$this->pages             = (int) ceil($this->total_no_pagination / $this->pagination->params->limit);
			$this->page              = (int) $this->pagination->params->page;
			$this->per_page          = $this->pagination->params->limit;
			$this->limit             = $this->pagination->params->total_limit;
			$this->next_page         = 1;
