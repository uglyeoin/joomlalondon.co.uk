...
class Values
{
	...
	public function getValue($key, $default = null, $attributes = null)
	{
		...
		switch ($key)
		{
			...
			case  'this':
				...
				return CurrentArticle::get($attributes->value);
			...
			case  'user':
				...
				return JFactory::getUser()->get($attributes->value);
			...
			case  'input':
				...
				return self::getValueFromInput('input:' . $attributes->value);
		}
	...
	{
		$key = RL_RegEx::replace('^category_image$', 'image-category-url', $key);
		...
		$aliases = [
			...
			'image-category-url' => ['category-image-url'],
