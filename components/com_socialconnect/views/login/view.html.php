...
class SocialConnectViewLogin extends SocialConnectView
{
	...
	private function addStyles()
	{
		...
		{
			$document->addStylesheet(JURI::root(true).'/templates/'.$application->getTemplate().'/html/com_socialconnect/'.$params->get('template', 'default').'/css/style.css?v=1.8.0');
		}
		else
		{
			$document->addStylesheet(JURI::root(true).'/components/com_socialconnect/templates/'.$params->get('template', 'default').'/css/style.css?v=1.8.0');
		}
