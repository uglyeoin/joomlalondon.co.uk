...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		getBarCount: function getBarCount() {
			var me = this;
			vêøw    êøw                    –p7            ê¢Z    ¯øw            ∞øw     @      ∞øw            a = me.chart.getDatasetMeta(datasetIndex);
...
module.exports = function(Chart) {
	...
	helpers.nextItem = function(collection, index, loop) {
		...
		return index >= collection.length - 1 ? collection[collection.length - êøw    êøw                    –p7            ê¢Z    ¯øw            ∞øw     @      ∞øw            p) {
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.tooltips = {
		...
		footerSpacing: 2,
		footerMarginTop: 6,
		footerFontColoêøw    êøw                    –p7            ê¢Z    ¯øw            ∞øw     @      ∞øw            nter',
		caretSize: 5,
		cornerRadius: 6,
