...
<div id="jem" class="jem_venue<?php echo $this->pageclass_sfx;?>" itemscope="itemscope" itemtype="http://schema.org/Place">
	...
	<!--Venue-->
	<h2 class="jem">
		<?php echo JText::_('COM_JEM_VENUE'); ?>	<?php echo '<span class="pull-right">' . JemOutput::icalbutton($this->venue->id, 'venue') . '</span>'; ?>
	...
	<?php if (($this->settings->get('global_show_detlinkvenue', 1)) && (!empty($this->venue->url))) : ?>
		<dl class="location floattext">
			<dt class="venue websiteLabel"><?php echo JText::_('COM_JEM_WEBSITE').':'; ?></dt>
			<dd class="venue website">
	...
	<?php if ($this->settings->get('global_show_detailsadress', 1)) : ?>
		<dl class="location floattext address" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress"><!-- BW Modded to ease reading/copying -->
			<dt class="venue_address"><?php echo JText::_('COM_JEM_ADDRESS').':'; ?></dt>
			<?php
			for ($cr = 1; $cr <= 10; $cr++) {
