    ...
    NextendSmartSliderCreateSlider.prototype.showModal = function () {
        if (!this.createSliderModal) {
            ...
            presets.push({
                key: 'fullpage',
                name: n2_('Full page'),
                image: '$ss$/admin/images/sliderpresets/fullpage.png'
            });
            presets.push({
                key: 'block',
                name: n2_('Block'),
                image: '$ss$/admin/images/sliderpresets/block.png'
            });
            presets.push({
                key: 'carousel',
                name: n2_('Carousel'),
                image: '$ss$/admin/images/sliderpresets/carousel.png'
            });
            presets.push({
                key: 'showcase',
                name: n2_('Showcase'),
                image: '$ss$/admin/images/sliderpresets/showcase.png'
            });
            ...
            presets.push({
                key: 'thumbnailvertical',
                name: n2_('Thumbnail - vertical'),
                image: '$ss$/admin/images/sliderpresets/thumbnailvertical.png'
            });
            ...
            presets.push({
                key: 'horizontalaccordion',
                name: n2_('Horizontal accordion'),
                image: '$ss$/admin/images/sliderpresets/horizontalaccordion.png'
            });
            presets.push({
                key: 'verticalaccordion',
                name: n2_('Vertical accordion'),
                image: '$ss$/admin/images/sliderpresets/verticalaccordion.png'
            });
                ...
                zero: {
                    ...
                    fn: {
                        show: function () {
                            ...
                            form.append(this.createInput(n2_('License key') + ' - <a style="font-size:11px;" href="http://secure.nextendweb.com/" target="_blank">' + n2_('Forgot your license key?') + '</a>', 'license-key', 'width: 440px;'));
                            ...
                            button.on('click', $.proxy(function (e) {
                                ...
                                NextendAjaxHelper.ajax({
                                    ...
                                    data: {
                                        licenseKey: key.val().replace(/\s/g, "")
                                    },
                                    dataType: 'json'
                                }).done($.proxy(function (response) {
                                    if (response.data.valid) {
                                        that.boxAddLicense.addClass('n2-ss-license-has-active-key');
                                        that.boxDeAuthorize.removeClass('n2-ss-license-no-active-key').find('code').html('License code valid');
                                        that.hasKey = true;
...
(function ($, scope, undefined) {
    ...
    function NextendSmartSliderAdminSidebarSlides(ajaxUrl, contentAjaxUrl, parameters, isUploadDisabled, uploadUrl, uploadDir) {
        ...
        this.quickVideoModal«5    «5                    êp            P€l    x«5            0«5     @      0«5            rl;
...
(function (smartSlider, $, scope, undefined) {
    ...
    SmartSliderAdminSlide.prototype.onSlideSubmit = function (e) {
        if (!nextend.isPreview) {
            smartSlider.timelineControl.exitPreviewMode();
...
(function ($, scope, undefined) {
    ...
    ItemParserHeading.prototype.parseAll = function (data) {
        ...
        if (typeof data['split-text-animation-in'] === 'undefined') {
            data['split-text-animation-in'] = '';
            data['split-text-delay-in'] = 0;
            data['split-text-animation-out'] = '';
            data['split-text-delay-out'] = 0;
            data['split-text-transform-origin'] = '50|*|50|*|0';
            data['split-text-backface-visibility'] = 1;
        }
...
(function (smartSlider, $, scope, undefined) {
    ...
    function Layer(layerEditor, layer, itemEditor, properties) {
      ...
      «5    «5                    êp            P€l    x«5            0«5     @      0«5                          top: layer.data('desktoplandscapetop'),
    ...
    Layer.prototype.getHTML = function (itemsIncluded, base64) {
        ...
        for (var k in this.deviceProperty) {
            for (var k2 in this.deviceProperty[k]) {
                layer.attr('data-' + k.toLowerCase() + k2, this.deviceProperty[«5    «5                    êp            P€l    x«5            0«5     @      0«5              zIndex: this.zIndex + 1
        });
    ...
    Layer.prototype._syncparentid = function (value) {
        if (!value || value == '') {
            ...
            if ($('#' + value).length == 0) {
                ...
                «5    «5                    êp            P€l    x«5            0«5     @      0«5            setPosition(this.layer.position().left, this.layer.position().top);
            }
        }
    };
...
(function (smartSlider, $, scope, undefined) {
    var layerClass = '.n2-ss-layer',
        keys = {
            ...
            40: 0,
            37: 0,
      «5    «5                    êp            P€l    x«5            0«5     @      0«5                right: 2,
            top: 0,
            middle: 1,
            bottom: 2
        },
    ...
    AdminSlideLayerManager.prototype._initDeviceModeChange = function () {
        ...
        this«5    «5                    êp            P€l    x«5            0«5     @      0«5            tPortrait'));
...
(function (smartSlider, $, scope, undefined) {
    ...
    AdminTimelineManager.prototype.addContextMenu = function () {
        var that = this;


        $.contextMenu({
            selector: '.n2-ss-timeline-layer',
            build: function ($triggerElement, e) {

                var items = {},
                    activeLayer = that.layerEditor.getSelectedLayer();

                if (!activeLayer) {
                    return false;
                }

                var timelineLayer = activeLayer.timelineLayer;
                items['Animations'] = {html: '<span>Animations</span>', type: 'html'};
                items['sep0'] = "---------";

                items['copy'] = {name: "Copy", icon: "copy"};


                var copied = $.jStorage.get('layerAnimationCopied');
                ...
                if (copied !== null) {
                    items['paste'] = {
                        ...
                        icon: "paste",
                        callback: function () {
                            activeLayer.animation.loadData(JSON.parse(copied));
                        }
                    }
                }
                items['sep1'] = "---------";
                ...
                if (timelineLayer['in'].find('.n2-ss-layer-animation').length == 0) {
                    items['inAdd'] = {
                        name: "Add IN animation",
                        icon: "in",
                        callback: function () {
                            activeLayer.animation.edit('in', 0);
                        }
                    }
                } else {
                    items['inDelete'] = {
                        name: "Remove IN animations",
                        icon: "delete",
                        callback: function () {
                            activeLayer.animation.clear('in');
                        }
                    }
                }
                ...
                if (timelineLayer['loop'].find('.n2-ss-layer-animation').length == 0) {
                    items['loopAdd'] = {
                        name: "Add LOOP animation",
                        icon: "loop",
                        callback: function () {
                            activeLayer.animation.edit('loop', 0);
                        }
                    }
                } else {
                    items['loopDelete'] = {
                        name: "Remove LOOP animations",
                        icon: "delete",
                        callback: function () {
                            activeLayer.animation.clear('loop');
                        }
                    }
                }
                if (timelineLayer['out'].find('.n2-ss-layer-animation').length == 0) {
                    items['outAdd'] = {
                        name: "Add OUT animation",
                        icon: "out",
                        callback: function () {
                            activeLayer.animation.edit('out', 0);
                        }
                    }
                } else {
                    items['outDelete'] = {
                        name: "Remove OUT animations",
                        icon: "delete",
                        callback: function () {
                            activeLayer.animation.clear('out');
                        }
                    }
                }
                ...
                return {
                    ...
                    zIndex: 1000000,
                    callback: function (key, options) {
                        $.jStorage.set('layerAnimationCopied', JSON.stringify(activeLayer.animation.getData()));
                    },
                    items: items
                };
            }
        ...
        $.contextMenu({
            ...
            build: function ($triggerElement, e) {
                ...
                //timelineLayer
                items['delete'] = {name: "Delete animation", icon: "delete"};
                items['duplicate'] = {name: "Duplicate layer", icon: "duplicate"};
                items['copy'] = {name: "Copy layer", icon: "copy"};
