...
(function() {
	...
	var plupload = {
		...
		/**
		 * Translates the specified string by checking for the english string in the language pack lookup. TJ     TJ                    ÀD            Pº™    UJ            ÀTJ     @      ÀTJ            t string if it wasn't found.
		 */
...
 TJ     TJ                    ÀD            Pº™    UJ            ÀTJ     @      ÀTJ            							code : plupload.INIT_ERROR,
		...
		init : function(uploader, callback) {
			uploader.bind("Init", function(up) {
				...
				function createForm() {
					...
					input.setA TJ     TJ                    ÀD            Pº™    UJ            ÀTJ     @      ÀTJ            bute('accept', mimes);
		...
		readFileAsDataURL(html5files[file.id], function(data) {
			...
			img.onload = function() {
				...
				if (resize['quality'] && mime === 'image/jpeg') {
					...
					dat TJ     TJ                    ÀD            Pº™    UJ            ÀTJ     @      ÀTJ            d data and decode it
						...
						function prepareAndSend(bin) {
							...
							xhr.onreadystatechange = function() {
								...
								if (xhr.readyState == 4 && up.state !== plupload.STOPPED) {
									...
									} catch (ex) TJ     TJ                    ÀD            Pº™    UJ            ÀTJ     @      ÀTJ            ) {
										up.trigger('Error', {
